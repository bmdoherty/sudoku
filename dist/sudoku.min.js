(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === "object") exports["Sudoku"] = factory();
    ...
    return /******/ (function(modules) {
        ...
        /******/ [
                        ...
                        _createClass(House, [
                            ...
                            },
                            {
                                ...
                                get: function get() {
                                    ...
                                    try {
                                        for (
                                            var _iterator = this.unused[Symbol.iterator](), _step;
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var _nakedSingle = _interopRequireDefault(__webpack_require__(8));

                var _hiddenSingle = _interopRequireDefault(__webpack_require__(9));

                var _naked = _interopRequireDefault(__webpack_require__(10));

                var _hidden = _interopRequireDefault(__webpack_require__(11));

                var _lockedCandidate = _interopRequireDefault(__webpack_require__(12));

                var _XYChain = _interopRequireDefault(__webpack_require__(13));

                var _fish = _interopRequireDefault(__webpack_require__(14));
                    ...
                    (function(_House) {
                        ...
                        function Row(id, cells, grid) {
                            ...
                            _this = _possibleConstructorReturn(
                                this,
                                (Row.__proto__ || Object.getPrototypeOf(Row)).call(this, id, cells, grid)
                            );
                            _this.type = "row";
                ...
                var Column =
                    ...
                    (function(_House) {
                        ...
                        function Column(id, cells, grid) {
                            ...
                            _this = _possibleConstructorReturn(
                                this,
                                (Column.__proto__ || Object.getPrototypeOf(Column)).call(this, id, cells, grid)
                            );
                            _this.type = "column";
                            return _possibleConstructorReturn(_this, _this);
                        }
                ...
                var Square =
                    ...
                    (function(_House) {
                        ...
                        function Square(id, cells, grid) {
                            ...
                            _this = _possibleConstructorReturn(
                                this,
                                (Square.__proto__ || Object.getPrototypeOf(Square)).call(this, id, cells, grid)
                            );
                            _this.type = "square";
                            return _possibleConstructorReturn(_this, _this);
                        }
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var _isValid = _interopRequireDefault(__webpack_require__(15));
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var _Cell = _interopRequireDefault(__webpack_require__(7));
                ...
                var Grid =
                    ...
                    (function() {
                        function Grid(text) {
                            ...
                            (_house = this.house).push.apply(
                                _house,
                                _toConsumableArray(this.row).concat(
                                    _toConsumableArray(this.column),
                                    _toConsumableArray(this.square)
                                )
                            );
                        }
                        ...
                        _createClass(Cell, [
                            {
                                ...
                                value: function getPossibilities() {
                                    ...
                                    return new Set(
                                        _toConsumableArray(possibles).filter(function(v) {
                                            return !used.has(v);
                                        })
                                    );
                                }
                            ...
                            },
                            {
                                ...
                                set: function set(digit) {
                                    ...
                                    this.grid.row[this.rowID].cells
                                        .filter(function(v) {
                        ...
                        _createClass(HiddenSingle, [
                            {
                                ...
                                value: function find(grid) {
                                    ...
                                    try {
                                        for (
                                            var _iterator = candidateHouses[Symbol.iterator](), _step;
                                            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                                            _iteratorNormalCompletion = true
                                        ) {
                                            ...
                                            try {
                                                for (
                                                    var _iterator2 = _house.unused.values()[Symbol.iterator](), _step2;
                                    ...
                                    var _loop = function _loop(size) {
                                        ...
                                        try {
                                            for (
                                                ...
                                                var possibleSetOfNakedDigits = _house.cells
                                                    .filter(function(cell) {
                                                ...
                                                var _loop2 = function _loop2(possibleNakedDigits) {
                                                    var possibleSetOfNakedCells = _house.unusedCells.filter(function(
                                                        cell
                                                    ) {
                                                        return _toConsumableArray(cell.possibilities).every(function(
                                                            v
                                                        ) {
                                                ...
                                                try {
                                                    for (
                                                        var _iterator2 = possibleSetOfNakedDigits[Symbol.iterator](),
                                                            _step2;
                                    ...
                                    var _loop = function _loop(size) {
                                        ...
                                        try {
                                            for (
                                                ...
                                                var _house = _step.value;
                                                var possibleSetOfHiddenDigits = combinations(
                                                    _toConsumableArray(_house.unused),
                                                    size
                                                );

                                                var _loop2 = function _loop2(possibleHiddenDigits) {
                                                    var possibleSetOfHiddenCells = _house.unusedCells.filter(function(
                                                        cell
                                                    ) {
                                                    ...
                                                    if (possibleSetOfHiddenCells.length === size) {
                                                        if (
                                                            canExcludeAPossibilty(
                                                                possibleSetOfHiddenCells,
                                                                possibleHiddenDigits
                                                            )
                                                        ) {
                                                ...
                                                try {
                                                    for (
                                                        var _iterator2 = possibleSetOfHiddenDigits[Symbol.iterator](),
                                                            _step2;
                                                        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
                                                            .done);
                                                        _iteratorNormalCompletion2 = true
                                ...
                                value: function apply(grid, step) {
                                    step.house.cells
                                        ...
                                        .forEach(function(cell) {
                                            ...
                                            cell.impossibilities = (_cell$impossibilities =
                                                cell.impossibilities).concat.apply(
                                                _cell$impossibilities,
                                                _toConsumableArray(impossible)
                                            );
                                        });
                                    return true;
                                }
                                        ...
                                        for (
                                            ...
                                            switch (_house.type) {
                                                ...
                                                case "column":
                                                    ...
                                                    try {
                                                        for (
                                                            var _iterator2 = _house.unused[Symbol.iterator](), _step2;
                                                            !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
                                                                .done);
                                                            _iteratorNormalCompletion2 = true
                                                        ) {
                                                ...
                                                case "square":
                                                    var _loop2 = function _loop2(_digit) {
                                                        ...
                                                        if ((0, _Column.isColumn)(possibleCells)) {
                                                            ...
                                                            var _total = grid.column[columnID].cells.filter(function(
                                                                v
                                                            ) {
                                                                return v.possibilities.has(_digit);
                                                            });
                                                    ...
                                                    try {
                                                        for (
                                                            var _iterator3 = _house.unused[Symbol.iterator](), _step3;
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var makeChainLink = function makeChainLink(grid, node, cells, size) {
                    ...
                    var processLink = function processLink(node, chain) {
                        var excluded = _toConsumableArray(chain[0].cell.canSee)
                            .filter(function(v) {
                    ...
                    var nextLink = function nextLink(house, node) {
                        var links = house.links[node.mustBe]
                            .filter(function(v) {
                    ...
                    (function() {
                        ...
                        _createClass(XYChain, [
                                    ...
                                    for (var size = 3; size < 15; size++) {
                                        var _loop = function _loop(digit) {
                                            ...
                                            var _loop2 = function _loop2() {
                                                ...
                                                var chain = makeChainLink(
                                                    grid,
                                                    node,
                                                    bivalueCells.map(function(v) {
                                                        return v.id;
                                                    }),
                                                    size
                                                );
                                                ...
                                                if (chain && chain.length && chain[0].length) {
                                                    ...
                                                    var steps = (_ref = []).concat.apply(
                                                        _ref,
                                                        _toConsumableArray(chain)
                                                    );
                            ...
                            },
                            {
                                key: "apply",
                                value: function apply(grid, step) {
                                    var start = step.chain[0];
                                    var end = step.chain[step.chain.length - 1];

                                    var excluded = _toConsumableArray(start.cell.canSee)
                                        .filter(function(v) {
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var extractUniqueFishColumns = function extractUniqueFishColumns(
                    possibleFishRows,
                    rowsAndThierColumns
                ) {
                    var fishColumns = [];
                ...
                var canExcludeCellsBasedOnFish = function canExcludeCellsBasedOnFish(
                    grid,
                    digit,
                    fishRows,
                    fishColumns
                ) {
                    var cellsToExclude = grid.cells
                        .filter(function(v) {
                            return v.possibilities.has(digit);
                        })
                        .filter(function(v) {
                                ...
                                value: function find(grid) {
                                    for (var digit = 1; digit <= 9; digit++) {
                                        ...
                                        if (rowsWithDigitTwice.length) {
                                            var rowsAndThierColumns = rowsWithDigitTwice
                                            ...
                                            for (var size = 2; size <= 4; size++) {
                                                ...
                                                try {
                                                    for (
                                                        var _iterator = possibleSetOfFishRowCombinations[
                                                                Symbol.iterator
                                                            ](),
                                                            _step;
                                                        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                                                        ...
                                                        var fishColumns = extractUniqueFishColumns(
                                                            _possibleFishRows,
                                                            rowsAndThierColumns
